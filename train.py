...
#from HigherHRNet import HigherHRNet
...
#model = PoseHigherResolutionNet(cfg = '/home/maihaoxiang/HigherHRNet-Human-Pose-Estimation-master/experiments/coco/higher_hrnet/HC18.yaml ').to(device)
model = HighResolutionNet(32, 4).to(device)
